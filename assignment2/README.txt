...
For task 1 and 2, data_dir is the path for folder imagenette-subset (in cell 5), so make sure to change the path to your dataset folder.

For task 3, path is in the first cell under task 3, make sure to change the path to the video to your path as well.